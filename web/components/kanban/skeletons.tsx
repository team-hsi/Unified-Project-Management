    ...
    <div className="bg-background rounded-lg border p-3 space-y-3">
      ...
      <div className="flex justify-between items-center pt-2">
        ...
        <div className="flex items-center gap-2">
          <Skeleton className=" bg-muted h-4 w-4" />
          <Skeleton className=" bg-muted h-4 w-6" />
        </div>
      </div>
    </div>
  );
...
export const KanbanColumnSkeleton = () => {
  return (
    <div className="w-72 shrink-0 rounded-md border p-3">
      <Skeleton className=" bg-muted flex  items-center w-full h-10 justify-between mb-3 px-2">
        <div className="flex items-center gap-2">
          <div className="h-5 w-5 rounded-full border flex items-center justify-center">
            <div className="h-2 w-2 rounded-full bg-muted-foreground"></div>
          </div>
          <Skeleton className="bg-muted h-5 w-16" />
          <Skeleton className="h-3 w-3 ml-1 bg-muted" />
        </div>
      </Skeleton>
